...
//
//setInterval(어떤일,3000)//3초마다 어떤 일이 실행
//setInterval(function(){어떤일},3000)//3초마다 어떤 일이 실행

//if(조건문){조건문이 참 일 때 실행되는 실행문}

//if(조건문){
//       조건문이 참 일 때 실행되는 실행문
//}else{조건문이 거짓 일 때 실행되는 실행문
//}
